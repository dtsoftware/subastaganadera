 ...
 * @author Tserng
 */
public class Listadodedepositos extends javax.swing.JFrame {

    /**
     * Creates new form Listadodepositos
     */
    public Listadodedepositos() {
        initComponents();
        Date date = new Date();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Listadodedepositos.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Listadodedepositos().setVisible(true);
            }
        });
    }
